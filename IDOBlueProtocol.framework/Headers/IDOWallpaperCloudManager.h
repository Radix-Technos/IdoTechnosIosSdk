...
@property (nonatomic , strong) IDOWallpaperCloudModel *dialJsonObj;

@property (nonatomic, strong) IDODialInstallModel  *installModel;
...
@property (nonatomic,strong) NSArray <IDODialJsonFuncListModel *> *funcList;
