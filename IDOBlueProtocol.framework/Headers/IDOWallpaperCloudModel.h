...
@class IDODialJsonSelectedModel;

@class IDODialJsonBackgroundModel;
@class IDODialJsonClockModel;

//支持的功能表
@class IDODialJsonFuncModel;
@class IDODialJsonFuncListModel;
@class IDODialJsonFuncListItemModel;

//样式表
@class IDODialJsonStylesListModel;
@class IDODialJsonStylesFuncsModel;

//调色板
@class IDODialJsonPaletteModel;

@class IDODialJsonLocationModel;

@class IDODialJsonAppModel;

@class IDODialJsonCountTimerModel;

@class IDODialWallpaperModel;

@class IDODialJsonFunctionListModel;

@class IDODialJsonTimeListModel;
@class IDODialJsonTimeWidgetModel;
...
@property (nonatomic,strong)IDODialJsonSelectedModel *select;//默认选中的样式图；
...
@property (nonatomic,strong)NSArray<IDODialJsonBackgroundModel *> *backgrounds;//背景图

@property (nonatomic,strong)IDODialJsonFuncModel *funcInfo;//功能对象

@property (nonatomic,strong)IDODialJsonClockModel *clock;//功能对象

@property (nonatomic,strong)NSArray<IDODialJsonStylesListModel *> *styles;//样式表

@property (nonatomic,strong)NSArray<IDODialJsonPaletteModel *> *palettes;//调色板

@property (nonatomic,strong)NSArray<IDODialJsonLocationModel *> *locations;//样式表

@property (nonatomic, assign)NSInteger function_support;

@property (nonatomic, assign)NSInteger function_support_new;

@property (nonatomic,strong)NSArray<IDODialJsonFunctionListModel *> *function_list;

@property (nonatomic,strong)NSArray<IDODialJsonTimeListModel *> *time_widget_list;

/// 2.1.0 添加
@property (nonatomic,strong)IDODialJsonAppModel *app;//功能对象

/// 2.1.1 添加
@property (nonatomic,strong)NSArray<IDODialJsonCountTimerModel *> *counterTimers;//倒计时

///2.2.0 添加 壁纸云表盘的配置
@property (nonatomic,strong)IDODialWallpaperModel *cloudWallpaper;

///获取所有的功能表
- (NSArray<IDODialJsonFuncListModel *> *)getAllFunction:(NSInteger)funcIndex;
...
///获取指定名字的样式对象
- (IDODialJsonStylesListModel *)getStyleForName:(NSString *)styleName;

///获取指定名字的背景对象
- (IDODialJsonBackgroundModel *)getBackgroundForName:(NSString *)bgName;

- (IDODialJsonFuncListItemModel *)getFuncListItemForName:(NSString *)funcType;

+ (IDODialJsonFuncListItemModel *)getFuncListItemForName:(NSString *)funcType
                                           fromFuncsList:(NSArray<IDODialJsonFuncListModel *> *)funcList;
...
+ (NSIndexPath *)getSelectFunAtIndexInFuncList:(NSString *)type
                                    dataSource:(NSArray<IDODialJsonFuncListModel *> *)datasource;
...
///获取选中照片表盘时间功能位置
- (IDODialJsonLocationModel *)getSelectedLocation;

@end

@interface IDODialJsonSelectedModel: NSObject
...
@interface IDODialJsonBackgroundModel: NSObject
...
@interface IDODialJsonClockModel: NSObject
...
@interface IDODialJsonFuncModel: NSObject
...
@property (nonatomic, strong) NSArray<IDODialJsonFuncListModel *>  *list;

@property (nonatomic, strong) NSArray<IDODialJsonStylesFuncsModel *> *defaultFuncs;

- (IDODialJsonFuncListItemModel *)getFuncsModelWithName:(NSString *)funcName;
...
@interface IDODialJsonFunctionListItemModel: NSObject
...
@interface IDODialJsonFunctionListModel: NSObject
@property (nonatomic,   assign) int function;
@property (nonatomic,   copy) NSString *name;
@property (nonatomic,   copy) NSString *small_icon;
@property (nonatomic, strong) NSArray<IDODialJsonFunctionListItemModel *> *item;
@end

@interface IDODialJsonFuncListModel: NSObject

@property (nonatomic,   copy) NSString *type;//类型

@property (nonatomic, strong) NSArray<IDODialJsonFuncListItemModel *> *items;

- (NSString *)getTypeName;

+ (NSArray <IDODialJsonFuncListModel *>*)getWallperDialDefaultsFuncs;

@end


@interface IDODialJsonFuncListItemModel: NSObject
...
@interface IDODialJsonStylesListModel: NSObject
...
@interface IDODialJsonStylesFuncsModel: NSObject
...
@interface IDODialJsonPaletteModel: NSObject
...
#pragma mark - 照片表盘的位置
@interface IDODialJsonFunctionItemModel: NSObject
@property (nonatomic, copy) NSString* widget;
@property (nonatomic, copy) NSString* type;
...
@interface IDODialJsonFunctionCoordinateModel: NSObject
@property (nonatomic, assign) NSInteger function;
@property (nonatomic, strong) NSArray<IDODialJsonFunctionItemModel *>  *item;
@end



@interface IDODialJsonLocationModel: NSObject
...
///功能
@property (nonatomic, strong)NSArray<IDODialJsonFunctionCoordinateModel*> *function_coordinate;

@property (nonatomic, strong)NSArray<IDODialJsonTimeWidgetModel*> *time_widget;


@end


@interface IDODialJsonAppModel: NSObject
...
@interface IDODialJsonCountTimerModel: NSObject
...
///照片云表盘Model  2.2.0添加
@interface IDODialWallpaperModel: NSObject
...
@interface IDODialInstallModel : NSObject
...
@interface IDODialJsonTimeListModel: NSObject
...
@interface IDODialJsonTimeWidgetModel: NSObject
@property (nonatomic, copy) NSString* widget;
@property (nonatomic, copy) NSString* type;
@property (nonatomic, copy) NSString* font;
@property (nonatomic, assign) int fontnum;
